		...
		$.ajax({
			...
			success: function (data){
				...
				$.each(data.dataList,function (index,customer){
					...
					html += "<td><a style=\"text-decoration: none; cursor: pointer;\" onclick=\"window.location.href='workbench/customer/detail.html';\">"+ customer.name +"</a></td>",
				...
				<table class="table table-hover">
					...
					<tbody id="customerBody">
						<!--<tr>
							...
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/customer/detail.html';">动力节点</a></td>
							<td>zhangsan</td>
							<td>010-84846003</td>
